...
FROM flight
WHERE flight_id = 'A';
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/COMBINED.csv' INTO TABLE temp_tbl FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' (
	@flight_id,
	@flightnumber,
	@departure_date,
	@arrival_date,
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/COMBINED.csv' INTO TABLE temp_tbl_2 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' (
	@flight_id,
	@flightnumber,
	@departure_date,
	@arrival_date,
