...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/All_2023_04_20.csv' INTO TABLE temp_tbl_3 FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' (
	@flight_id,
	@flightnumber,
	@departure_date,
	@arrival_date,
...
SET airline_iata_code = @airline_iata_code;

INSERT INTO airline(airline_iata_code)
SELECT *
FROM temp_tbl_3;
